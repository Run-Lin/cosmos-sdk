...
You can edit the `~/.gaiad/config/cosmos.toml` file in order to enable the anti spam mechanism and reject incoming transactions with less than a minimum fee:
